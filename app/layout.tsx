...
import AmiciaArchitect from "@/components/amicia-architect";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        className={`${inter.className} bg-gray-50 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90 text-gray-950 relative`}
      >
        {/* bg blur effect */}
